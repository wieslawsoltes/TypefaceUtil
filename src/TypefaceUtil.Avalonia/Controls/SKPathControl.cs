...
namespace TypefaceUtil.Avalonia.Controls
{
    ...
    public class SKPathControl : Control, IAffectsRender
    {
        ...
        /// </summary>
        public static readonly StyledProperty<SkiaSharp.SKPath?> PathProperty =
            AvaloniaProperty.Register<SKPathControl, SkiaSharp.SKPath?>(nameof(Path));

        /// <summary>
        /// Defines the <see cref="Paint"/> property.
        /// </summary>
        public static readonly StyledProperty<SkiaSharp.SKPaint?> PaintProperty =
            AvaloniaProperty.Register<SKPathControl, SkiaSharp.SKPaint?>(nameof(Paint));
        ...
        public static readonly StyledProperty<StretchDirection> StretchDirectionProperty =
            AvaloniaProperty.Register<SKPathControl, StretchDirection>(
        ...
        /// <summary>
        /// Gets or sets the <see cref="SkiaSharp.SKPath"/> path.
        /// </summary>
        [Content]
        public SkiaSharp.SKPath? Path
        {
        ...
        /// <summary>
        /// Gets or sets the <see cref="SkiaSharp.SKPaint"/> paint.
        /// </summary>
        public SkiaSharp.SKPaint? Paint
        {
